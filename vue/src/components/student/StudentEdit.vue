<template>
    <div class="main-container rounded px-5 m-2" style="width: 60%">
        <div>
            <h1 style="color: antiquewhite; padding: 5px 5px;">Student Edit</h1>
        </div>
        <form @submit.prevent="updateStudent(student.id)" class="input-text py-2">
            <div class="mb-3">
...
export default {
    ...
    methods: {
        updateStudent(id) {
            ...
            axios.put(`http://localhost:8000/api/students/${id}/edit`, this.student)
                .then(response => {
